...
export declare type AddedOwner = ContractEventLog<{
    owner: string;
    0: string;
}>;
export declare type ApproveHash = ContractEventLog<{
    approvedHash: string;
    owner: string;
    0: string;
    1: string;
}>;
export declare type ChangedFallbackHandler = ContractEventLog<{
    handler: string;
    0: string;
}>;
export declare type ChangedGuard = ContractEventLog<{
    guard: string;
    0: string;
}>;
export declare type ChangedThreshold = ContractEventLog<{
    threshold: string;
    0: string;
}>;
export declare type DisabledModule = ContractEventLog<{
    module: string;
    0: string;
}>;
export declare type EnabledModule = ContractEventLog<{
    module: string;
    0: string;
}>;
export declare type ExecutionFailure = ContractEventLog<{
    txHash: string;
    payment: string;
    0: string;
    1: string;
}>;
export declare type ExecutionFromModuleFailure = ContractEventLog<{
    module: string;
    0: string;
}>;
export declare type ExecutionFromModuleSuccess = ContractEventLog<{
    module: string;
    0: string;
}>;
export declare type ExecutionSuccess = ContractEventLog<{
    txHash: string;
    payment: string;
    0: string;
    1: string;
}>;
export declare type RemovedOwner = ContractEventLog<{
    owner: string;
    0: string;
}>;
export declare type SafeReceived = ContractEventLog<{
    sender: string;
    value: string;
    0: string;
    1: string;
}>;
export declare type SafeSetup = ContractEventLog<{
    initiator: string;
    owners: string[];
    threshold: string;
    initializer: string;
...
export declare type SignMsg = ContractEventLog<{
    msgHash: string;
    0: string;
}>;
