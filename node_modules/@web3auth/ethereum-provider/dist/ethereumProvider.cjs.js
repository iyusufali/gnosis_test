...
class WalletConnectProvider_WalletConnectProvider extends base_provider_["BaseProvider"] {
  ...
  async switchChain(_ref2) {
    ...
    try {
      ...
      base_["log"].error(error); // ignore this error because metamask & others return provider.result as null
  ...
  async onConnectorStateUpdate(connector) {
    connector.on("session_update", async (error, payload) => {
      ...
      if (connectedChainId && this.state.chainId !== connectedHexChainId) {
        const maybeConfig = Object(base_["getChainConfig"])(base_["CHAIN_NAMESPACES"].EIP155, connectedChainId) || {}; // Handle rpcUrl update
