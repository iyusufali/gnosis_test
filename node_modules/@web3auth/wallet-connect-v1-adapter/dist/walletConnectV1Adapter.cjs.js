...
var ethereum_provider_ = __webpack_require__(3);

// CONCATENATED MODULE: ./src/config.ts

const WALLET_CONNECT_EXTENSION_ADAPTERS = [{
  name: "Rainbow",
  chains: [base_["CHAIN_NAMESPACES"].EIP155],
...
class walletConnectV1adapter_WalletConnectV1Adapter extends base_["BaseAdapter"] {
  ...
  async connect() {
    ...
    return new Promise((resolve, reject) => {
      ...
      try {
        ...
        base_["log"].error("Wallet connect v1 adapter error while connecting", error); // ready again to be connected
  ...
  async createNewSession() {
    ...
    return new Promise((resolve, reject) => {
      ...
      base_["log"].debug("creating new session for web3auth wallet connect");
      ...
      this.connector.createSession({
        ...
        base_["log"].error("error while creating new wallet connect session", error);
        this.emit(base_["ADAPTER_EVENTS"].ERRORED, error);
        return reject(error);
      });
    });
  ...
  async onConnectHandler(params) {
    ...
    base_["log"].debug("connected chainId in hex", chainId);
