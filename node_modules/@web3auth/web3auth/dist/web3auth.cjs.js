...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return defaultEvmDappModalConfig; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return defaultSolanaWalletModalConfig; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return defaultEvmWalletModalConfig; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return defaultOtherModalConfig; });
/* harmony import */ var _web3auth_base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
...
const getDefaultAdapterModule = async params => {
  ...
  if (name === base_["WALLET_ADAPTERS"].TORUS_EVM) {
    ...
    const {
      SolanaWalletAdapter
    } = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(null, 9, 7));
...
class modalManager_Web3Auth extends core_["Web3AuthCore"] {
  constructor(options) {
    ...
    defineProperty_default()(this, "modalConfig", config["a" /* defaultEvmDappModalConfig */]);
    ...
    if (providedChainConfig.chainNamespace === base_["CHAIN_NAMESPACES"].SOLANA) {
      ...
      if (options.authMode === "WALLET") {
        ...
        this.modalConfig = config["b" /* defaultEvmWalletModalConfig */];
      } else {
        // default config for evm dapp modal
        this.modalConfig = config["a" /* defaultEvmDappModalConfig */];
      }
    } else if (providedChainConfig.chainNamespace === base_["CHAIN_NAMESPACES"].OTHER) {
      this.modalConfig = config["c" /* defaultOtherModalConfig */];
    } else {
  ...
  async initModal(params) {
    ...
    const hasInAppWallets = Object.values(this.walletAdapters).some(adapter => {
      ...
      const mergedLoginMethods = Object(ui_["getAdapterSocialLogins"])(adapter.name, this.walletAdapters[adapter.name], (_adapter$name = this.modalConfig.adapters[adapter.name]) === null || _adapter$name === void 0 ? void 0 : _adapter$name.loginMethods);
  ...
  initializeInAppWallet(adapterName) {
    ...
    if (this.walletAdapters[adapterName].type === base_["ADAPTER_CATEGORY"].IN_APP) {
      ...
      this.loginModal.addSocialLogins(adapterName, Object(ui_["getAdapterSocialLogins"])(adapterName, this.walletAdapters[adapterName], (_adapterName = this.modalConfig.adapters[adapterName]) === null || _adapterName === void 0 ? void 0 : _adapterName.loginMethods), ((_this$options$uiConfi3 = this.options.uiConfig) === null || _this$options$uiConfi3 === void 0 ? void 0 : _this$options$uiConfi3.loginMethodsOrder) || ui_["OPENLOGIN_PROVIDERS"]);
    }
  }
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "defaultEvmDappModalConfig", function() { return _config__WEBPACK_IMPORTED_MODULE_0__["a"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "defaultEvmWalletModalConfig", function() { return _config__WEBPACK_IMPORTED_MODULE_0__["b"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "defaultOtherModalConfig", function() { return _config__WEBPACK_IMPORTED_MODULE_0__["c"]; });

/* harmony import */ var _interface__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _interface__WEBPACK_IMPORTED_MODULE_1__) if(["default","defaultSolanaDappModalConfig","defaultEvmDappModalConfig","defaultSolanaWalletModalConfig","defaultEvmWalletModalConfig","defaultOtherModalConfig"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _interface__WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var _modalManager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5);
